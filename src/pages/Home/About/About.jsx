...
function About() {
  return (
    <section id="about" className="relative bg-[#0A3D62] text-white py-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 md:px-16 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          <p className="text-amber-300 tracking-widest uppercase font-semibold">
            About Our Plumbing
          </p>
          ...
          <ul className="space-y-3 mt-3">
            {[
              ...
              >
                <Check className="text-amber-300 w-5 h-5" />
                {item}
              </motion.li>
            ))}
          </ul>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="cursor-pointer w-[250px] group mt-6 flex items-center justify-center gap-2 px-6 py-3 bg-amber-300 text-[#0A3D62] font-semibold rounded-full shadow-md hover:bg-amber-400 transition-all duration-300"
          >
            <span>Know More</span>
            <ArrowRightToLine
      ...
      <motion.img
        src="arrow.png"
        alt="arrow"
        className="absolute top-0 w-70 mt-114 ml-15"
        animate={{
